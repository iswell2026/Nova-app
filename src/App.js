...
const CONTRACTORS = [
  ...
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "TriVista USA Design+Build", sqft: "$110–$160", score: 97, phone: "703-865-6182", website: "trivistausa.com", specialty: "Full Home Luxury Renovation", review: "20년 경력, 수상 이력 다수. 아키텍트+인테리어디자이너 인하우스. Fairfax·Arlington 전문.", rating: "4.9★ (200+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Ridgeline Contractors (DMV)", sqft: "$95–$145", score: 96, phone: "301-825-1726", website: "ridgelinedmv.com", specialty: "Luxury Bath & Kitchen", review: "NoVA 최고 럭셔리 리모델러 자타공인. 보험 클레임 처리까지 지원. Malcolm 대표 직접 관리.", rating: "5.0★ (180+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Bowers Design Build", sqft: "$100–$155", score: 95, phone: "703-506-0845", website: "bowersdesignbuild.com", specialty: "Custom Home & Whole House Remodel", review: "1990년 창립. NRS 고객만족 수상. 30% 재방문 고객. McLean·Great Falls 전문.", rating: "4.9★ (150+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Commonwealth Home Design", sqft: "$90–$140", score: 94, phone: "703-938-2121", website: "commonwealthhomedesign.com", specialty: "Whole House Renovation + Addition", review: "40년 Vienna 기반. 구조 변경·증축 전문. 프로젝트 관리 시스템 우수.", rating: "4.8★ (120+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Foster Remodeling Solutions", sqft: "$85–$135", score: 93, phone: "703-471-7511", website: "fosterremodeling.com", specialty: "Design-Build / Basement + Addition", review: "업계 최고 보증 제공. 디자인팀 인하우스. Herndon·Reston 전문.", rating: "4.9★ (200+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Ideal Construction & Remodeling", sqft: "$88–$138", score: 92, phone: "703-879-4484", website: "idealconstructionva.com", specialty: "Green Build + Luxury Remodel", review: "Arlington County 그린홈 수상. 에너지 효율 특화. DC·Arlington 전문.", rating: "4.8★ (90+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Monova Homes", sqft: "$92–$142", score: 91, phone: "571-264-5040", website: "monovahomes.com", specialty: "Full Home Renovation", review: "예산·일정 준수로 유명. Alexandria·Fairfax 기반. 투자자 친화적.", rating: "4.9★ (80+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "WISA Solutions", sqft: "$80–$130", score: 90, phone: "703-455-2212", website: "wisasolutions.com", specialty: "Kitchen & Bath Luxury", review: "West Springfield 기반. 고객 추천율 높음. 주방·욕실 럭셔리 전문.", rating: "4.8★ (100+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Total Construction Company", sqft: "$85–$132", score: 89, phone: "703-273-2929", website: "totalconstructionco.com", specialty: "Whole House + Custom Millwork", review: "34년 경력. 수영장·야외공간 포함 풀서비스. Fairfax County 전문.", rating: "4.8★ (140+ reviews)" },
  { category: "luxury", label: "🏆 Luxury / Heavy", name: "Heartland Design & Remodeling", sqft: "$82–$128", score: 88, phone: "571-220-0505", website: "heartlandremodeling.com", specialty: "Custom Design + Renovation", review: "Bristow·Prince William 기반. 고객 소통 우수. 맞춤 설계 강점.", rating: "4.7★ (70+ reviews)" },

  // ── 📈 FLIP MEDIUM (플립 전문 중급) ────────────────────────────────────
  { category: "flip", label: "📈 Flip / Medium", name: "NHR Kitchen & Floors (NOVA Home Renovate)", sqft: "$55–$85", score: 95, phone: "703-499-0040", website: "novahomerenovate.com", specialty: "Kitchen + Bath + Flooring Flip", review: "Fairfax County ALU 허가 전문. 일정·예산 매일 커뮤니케이션. 투자자 재이용률 매우 높음.", rating: "5.0★ (300+ reviews)" },
  { category: "flip", label: "📈 Flip / Medium", name: "All Renovations", sqft: "$48–$78", score: 93, phone: "703-596-0000", website: "allrenovations.com", specialty: "Investor Flip Specialist", review: "Class A VA 라이선스. 전기+배관 특화. 가성비 1위. Vienna·Sterling 전문. 4.9★ 38개 리뷰.", rating: "4.9★ (38 verified)" },
  { category: "flip", label: "📈 Flip / Medium", name: "DMV Remodeling Pros", sqft: "$52–$80", score: 91, phone: "703-348-2100", website: "dmvremodelingpros.com", specialty: "Fast Flip Turnaround", review: "90일 내 완공 보장. Permit 처리 경험 풍부. Manassas·Centreville 기반.", rating: "4.7★ (110+ reviews)" },
  { category: "flip", label: "📈 Flip / Medium", name: "Capital Remodeling", sqft: "$50–$82", score: 90, phone: "301-649-0900", website: "capitalremodeling.com", specialty: "Kitchen + Flooring Flip Package", review: "DC·VA·MD 트라이스테이트. 패키지 견적 빠름. 투자자 대량 계약 경험.", rating: "4.6★ (250+ reviews)" },
  { category: "flip", label: "📈 Flip / Medium", name: "Fairfax Contracting Group", sqft: "$55–$83", score: 89, phone: "703-425-7070", website: "fairfaxcontracting.com", specialty: "Flip & Rental Turnover", review: "Fairfax County Permit 최단 처리. 다중 현장 동시 관리 가능. 투자자 전용 할인.", rating: "4.7★ (90+ reviews)" },
  { category: "flip", label: "📈 Flip / Medium", name: "Renovate DMV", sqft: "$48–$75", score: 88, phone: "571-449-3300", website: "renovatedmv.com", specialty: "Medium Flip Full Package", review: "주방+욕실+바닥 패키지 전문. Sterling·Ashburn 기반. ROI 최적화 경험 많음.", rating: "4.6★ (75+ reviews)" },
  ...
  { category: "flip", label: "📈 Flip / Medium", name: "Blueprint Renovation LLC", sqft: "$53–$80", score: 85, phone: "571-330-8800", website: "blueprintrenovation.com", specialty: "Design+Build Flip", review: "3D 렌더링 무료 제공. Reston·Herndon 전문. 빠른 견적 48시간 보장.", rating: "4.5★ (50+ reviews)" },
  ...
  { category: "rental", label: "🏠 Rental / Light", name: "HomeFix Pro VA", sqft: "$16–$27", score: 84, phone: "571-312-4400", website: "homefixprova.com", specialty: "Rental Repair & Light Refresh", review: "도배+도색+바닥 교체 전문. Centreville·Chantilly 기반. 24시간 견적 대응.", rating: "4.4★ (85+ reviews)" },
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8 }}>
                          ...
                          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                            ...
                            <a href={"https://" + c.website} target="_blank" rel="noreferrer"
                              style={{ fontSize: 9, color: "var(--blue)", textDecoration: "none", background: "var(--blue2)", padding: "4px 10px", borderRadius: 100, fontWeight: 700 }}>웹사이트 →</a>
                            <a href={`mailto:?subject=Construction Estimate Request - ISWELL PROPERTIES&body=Hello ${c.name},%0D%0A%0D%0AMy name is David Kim with ISWELL PROPERTIES.
Email: iswell.properties@gmail.com%0D%0AWe are requesting a construction estimate for a property we are acquiring.%0D%0A%0D%0A• Property Address: ${deal.address || "TBD"}%0D%0A• Purchase Price: $${deal.purchasePrice.toLocaleString()}%0D%0A• Building Size: ${deal.sqft} sqft%0D%0A• Year Built: ${deal.yearBuilt}%0D%0A• Contractor: ${c.name}%0D%0A• Phone: ${c.phone}%0D%0A• License: ${c.license}%0D%0A%0D%0APlease provide us with your estimate at your earliest convenience.%0D%0A%0D%0ABest regards,%0D%0ADavid Kim%0D%0AISWELL PROPERTIES%0D%0Aiswell.properties@gmail.com`}
